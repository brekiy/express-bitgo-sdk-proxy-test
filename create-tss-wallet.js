...
function createCustodialWallet() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, bitgo.coin('tnear').wallets().add({
                        type: 'custodial',
                        multisigType: 'tss',
                        isCustodial: true,
...
function createHotWalletSimple() {
    return __awaiter(this, void 0, void 0, function () {
        var newWallet;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, bitgo.coin('tsol').wallets().generateWallet({
...
function createHotMultiSigWalletSimple() {
    return __awaiter(this, void 0, void 0, function () {
        var newWallet;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, bitgo.coin('tbtc').wallets().generateWallet({
...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, createHotMultiSigWalletSimple()];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
